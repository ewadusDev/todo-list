...
const LeftSidebar = () => {
    ...
    return (
        <aside className={`${isShown ? 'block' : 'hidden'} w-[300px] h-[calc(100vh-48px)] shadow-md/60 bg-white`}>
                        ...
                        {icons.map((icon, index) => {
                            return (
                                <Link href={icon.path} key={index}>
                                    <li className="flex h-12 justify-start items-center gap-6 pl-8  hover:cursor-pointer hover:bg-gray-200 ">
