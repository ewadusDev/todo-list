...
const icons = [
  ...
  { name: "doneIcon", icon: CheckedIcon },
];
...
const TopMenu = ({
  ...
  return (
    <div className="flex justify-between w-full h-[55px] border">
      <div className="flex gap-6">
        <div
          className="flex flex-row text-2xl gap-1 items-center text-[#1C78C3] hover:cursor-pointer"
          id="header"
        >
          <IconTitle
            width={33}
        ...
        <div
          className="flex flex-row text-md gap-1 items-center text-[#1C78C3] hover:cursor-pointer"
      ...
      <div
        className="flex text-md gap-1 items-center text-[#1C78C3] select-none hover:cursor-pointer"
        onClick={handleIsSorted}
      >
        {isSorted ? (
          <SortDownIcon width={25} height={25} stroke="#1C78C3" />
        ) : (
          <SortUpIcon width={24} height={24} stroke="#1C78C3" />
        )}
        Sort
      </div>
    </div>
